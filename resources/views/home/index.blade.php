    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-10">
                ...
                <form class="form-search form" action="{{ route('geocoding') }}" method='get' >
                    @csrf
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 ml-auto order-lg-1">
                ...
                <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Repudiandae, explicabo iste a labore id est quas, doloremque veritatis!
                    Provident odit pariatur dolorem quisquam, voluptatibus voluptates optio accusamus, vel quasi quidem!
                </p>
